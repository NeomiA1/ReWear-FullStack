...
// רכיב משותף לבחירת/דפדוף עמותות — משתמש באותו מקור נתונים אמיתי
// (getAllAssociations), אותו מנוע המלצות (rankAssociations) ואותם פילטרים
// בכל המסכים שמשתמשים בו, כדי שסדר ההמלצה יהיה זהה בכל מקום עבור אותם קלטים.
//
// props:
