    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route
          ...
          element={<RegisterPrivatePage />}
        />

        <Route
          path="/register/private/causes"
          element={
            <RequireAuth allowedRoles="private">
              <RegisterCausesPage />
            </RequireAuth>
          }
        />
        ...
        <Route
          path="/org/collaborations"
          element={
            <RequireAuth allowedRoles="org">
              <OrgCollaborationsPage />
            </RequireAuth>
          }
        />
